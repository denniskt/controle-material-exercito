...
<header>
<title>SISCMEX - Solicitação/Listar</title>
...
if(isset($_POST["procurar"])){
	$lista = Solicitacao::procurar($_POST["codigo"],$_POST["solicitante"],$_POST["setor"],$_POST["status"],NULL);
	$tipo = 4;
}else{
	$lista = Solicitacao::lista_todas($tipo);
}
