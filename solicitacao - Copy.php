...
<script>
$("#botao_carrinho").click(function () {
$("h3").hide();
$("#form_procurar").hide();
$("#form_carrinho").toggle();
});
</script>
<script>
...
<div id="form_lista" style="display: none">
<script type="text/javascript">

$(document).ready(function(){
$("#form_lista_solicitação").validate({
	rules: {
		material: {
			required: true,
			minlength: 5
...
<form id="form_solicitar_material" name="form_solicitar_material" method="post" action="">
<?php if(isset($msg)){ echo "<h3>$msg</h3>"; }?>
<p>nome material*:<br>
