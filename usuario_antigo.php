...
<table width='100%' border='1'>
	...
	<tr>
		...
		<td><a href='usuario_editar.php?id=<?php echo $linha['cd_identidade']?>'><img src="imagens/icone_editar.png"> editar</a> <a href='usuario_desativar.php?id=<?php echo $linha['cd_identidade']?>'>[<img src="imagens/inativo.png" width="15" height="15"> excluir</a></td>
	</tr>
	<?php } ?>
</table>
